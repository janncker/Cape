...
void Cape::decrypt(char *source,  uint8_t length) {
...
void Cape::crypt(char *source, char *destination, uint8_t length, bool initialization_vector, bool side) {
  uint8_t i = 0;
